...
$(function () {
  var subtext = $(".lib62329951_2 .crumbs").find("span").text();
  if (subtext != "") {
    $(".lib62329951_2 .crumbs span").addClass("has");
  }
});
$(function () {
  var positionx = $(".lib62345316_2wap1 .ditu").attr("data-x");
  var positiony = $(".lib62345316_2wap1 .ditu").attr("data-y");
  var name = $(".lib62345316_2wap1 .ditu").attr("data-name");
  var add = $(".lib62345316_2wap1 .ditu").attr("data-add");
  var px = parseFloat(positionx);
  var py = parseFloat(positiony);
  var lib62345316_2wap1map2 = new AMap.Map("lib62345316_2wap1ditu", {
    resizeEnable: true,
    zoom: 13,
    center: [px, py],
  });
  var lib62345316_2wap1marker2 = new AMap.Marker({
    position: [px, py],
    lib62345316_2wap1map2: lib62345316_2wap1map2,
  });
  lib62345316_2wap1marker2.setMap(lib62345316_2wap1map2);
  function refresh(e) {
    lib62345316_2wap1map2.setMapStyle("normal");
  }
  refresh();
  AMap.plugin(["AMap.ToolBar"], function () {
    lib62345316_2wap1map2.addControl(new AMap.ToolBar());
    lib62345316_2wap1marker2.setMap(lib62345316_2wap1map2);
    lib62345316_2wap1marker2.setTitle(name);
    lib62345316_2wap1marker2.setLabel({
      offset: new AMap.Pixel(50, -60),
      content:
        "<div class='arrow'></div><div class='info'>" +
        name +
  ...
  $(".lib62345316_2wap1 .mes .list ul li").each(function () {
    var textLen = $(this).find("h4").text();
    if (textLen == "") {
      $(this).hide();
    }
  });
...
$(function () {
  var positionx = $(".lib62345316_2 .ditu").attr("data-x");
  var positiony = $(".lib62345316_2 .ditu").attr("data-y");
  var name = $(".lib62345316_2 .ditu").attr("data-name");
  var add = $(".lib62345316_2 .ditu").attr("data-add");
  var px = parseFloat(positionx);
  var py = parseFloat(positiony);
  var lib62345316_2map2 = new AMap.Map("lib62345316_2ditu", {
    resizeEnable: true,
    zoom: 13,
    center: [px, py],
  });
  var lib62345316_2marker2 = new AMap.Marker({
    position: [px, py],
    lib62345316_2map2: lib62345316_2map2,
  });
  lib62345316_2marker2.setMap(lib62345316_2map2);
  function refresh(e) {
    lib62345316_2map2.setMapStyle("normal");
  }
  refresh();
  AMap.plugin(["AMap.ToolBar"], function () {
    lib62345316_2map2.addControl(new AMap.ToolBar());
    lib62345316_2marker2.setMap(lib62345316_2map2);
    lib62345316_2marker2.setTitle(name);
    lib62345316_2marker2.setLabel({
      offset: new AMap.Pixel(50, -60),
      content:
        "<div class='arrow'></div><div class='info'>" +
        name +
