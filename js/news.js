...
$(function () {
  var subtext = $(".lib62144237_2 .crumbs").find("span").text();
  if (subtext != "") {
    $(".lib62144237_2 .crumbs span").addClass("has");
  }
});
$(".list .classify2 ul li").each(function () {
...
var totalPage = $(".list .classify2").attr("data-pcount");
...
$(".lib62156920_3list2 .classify2 ul li").each(function () {
  var lib62156920_3list2src = $(this).find("img").attr("data-url");
  if (lib62156920_3list2src == "") {
    $(this)
      .find("img")
      .attr(
        "data-url",
...
var totalPage = $(".lib62156920_3list2 .classify2").attr("data-pcount");
for (i = 1; i <= totalPage; i++) {
  var op = new Option(i);
  op.label = i;
  op.value = "?menu_id=" + getParameter("menu_id") + "&page=" + i;
...
var hrefLatter = window.location.search;
$(function () {
  $(".lib62156920_3list2 .nextpage").attr(
    "href",
    "?menu_id=" + getParameter("menu_id") + "&page=" + 2
  );
  $(".lib62156920_3list2 .prepage").css({ color: "#999" });
  $("#food_selection option").each(function () {
    if (this.value == hrefLatter) {
      this.selected = true;
      var pre = parseInt(this.label) - 1;
      var nex = parseInt(this.label) + 1;
      if (this.label != 1) {
        $(".lib62156920_3list2 .prepage").attr(
          "href",
          "?menu_id=" + getParameter("menu_id") + "&page=" + pre
        );
        $(".lib62156920_3list2 .prepage").css({ color: "#333" });
      }
      if (this.label != totalPage) {
        $(".lib62156920_3list2 .nextpage").attr(
          "href",
      ...
      if (this.label == totalPage) {
        $(".lib62156920_3list2 .nextpage").removeAttr("href");
        $(".lib62156920_3list2 .nextpage").css({ color: "#999" });
      }
    }
  });
});
