...
$(function () {
  var subtext = $(".lib64329368_3 .crumbs").find("span").text();
  if (subtext != "") {
    $(".lib64329368_3 .crumbs span").addClass("has");
  }
});
$(".lib64342961_2wap1 .slidebox").slide({
  mainCell: "ul",
  autoPlay: true,
  effect: "leftMarquee",
  vis: 3,
...
var lib64342961_2wap1leg = $(".lib64342961_2wap1 .nav>ul>li").length;
if (lib64342961_2wap1leg == 1) {
  $(".lib64342961_2wap1 .nav").hide();
}
$(".lib64342961_2 .z").slide({
  mainCell: "ul",
  effect: "leftLoop",
  autoPlay: true,
  vis: 6,
...
$(function () {
  var lib64351722_3wap1tit_num = $(".lib64351722_3wap1 .sys_tit1 sysWapTitle")
      .find("h2")
      .text(),
    lib64351722_3wap1desc_num = $(".lib64351722_3wap1 .sys_tit1 sysWapTitle")
      .find("p")
      .text();
  if (lib64351722_3wap1tit_num == "" && lib64351722_3wap1desc_num == "") {
    $(".lib64351722_3wap1 .sys_tit1 sysWapTitle").hide();
  }
  var lib64351722_3wap1leg = $(".lib64351722_3wap1 .nav>ul>li").length;
  if (lib64351722_3wap1leg <= 1) {
    $(".lib64351722_3wap1 .nav").hide();
  }
  $(".lib64351722_3wap1 .nav ul li").each(function () {
  ...
  var lib64351722_3wap1href = $(
    ".lib64351722_3wap1 .more .partner-more"
  ).text();
  if (lib64351722_3wap1href == "") {
    $(".lib64351722_3wap1 .more").hide();
  }
  var lib64351722_3wap1maintit_num = $(".lib64351722_3wap1 .textcons")
    .find(".maintitle")
    .text();
  if (lib64351722_3wap1maintit_num == "") {
    $(".lib64351722_3wap1 .textcons").hide();
  }
});
$(".lib64351722_3 .honor1").slide({
  titOnClassName: "cur",
  mainCell: ".honor2 ul",
  autoPlay: true,
  effect: "leftLoop",
